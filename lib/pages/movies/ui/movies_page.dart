        ...
        child: BlocBuilder<MoviesBloc, MovieState>(
          ...
          builder: (_, state) {
            return state.when(
                ...
                loaded: (changes) => RefreshIndicator(
                      onRefresh: () async =>
                          moviesBloc..add(MoviesEvent.load()),
                      child: LazyLoadScrollView(
                        ...
                        child: ListView.separated(
                          ...
                          itemBuilder: (_, index) => Container(
                              ...
                              onTap: () => Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (_) => BlocProvider(
                                    create: (_) =>
                                        MovieDetailsBloc(MoviesRepository())
                                          ..add(
                                            MovieDetailsEvent.load(
                                              moviesBloc.changess.results![index].id!,
                                            ),
                                          ),
                                    child: MovieDetails(
                                      title: moviesBloc.changess.results![index].title!,
                                    ),
                                  ),
                                ),
                              ),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: Text(
                                            moviesBloc.changess.results![index].voteAverage
                                                .toString(),
                                          ),
                                        ),
                                        Container(
                            ...
                            // child: Center(
                            //   child: Image.network(
                            //     baseUrlImage + moviesBloc.changess.results![index].posterPath!,
                            //   ),
                            // ),
                          ),
                        ),
                ...
                onOffline: (savedChangess) {
                  return ValueListenableBuilder<Box<Results>>(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Text(
                                          savedChangess.values.toList()[index].voteAverage
                                              .toString(),
                                        ),
                                      ),
                                      Container(
                                  ...
                                  Expanded(
                                    child: Center(
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            savedChangess.values.toList()[index].originalTitle!,
                                            style: TextStyle(
                                              color: AppColors.whiteColors,
                                              fontSize: 18,
                                              fontWeight: FontWeight.bold,
                                          ...
                                          UIHelper.verticalSpace(
                                              getProportionateScreenHeight(10)),
                                          Text(
                                            savedChangess.values.toList()[index].releaseDate!,
                                            style: TextStyle(
                                              color: AppColors.whiteColors,
                                              fontSize: 18,
                                              fontWeight: FontWeight.bold,
